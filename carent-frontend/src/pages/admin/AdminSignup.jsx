...
export default function AdminSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) return toast.error(data.message || "Admin signup failed.");
  ...
  return (
    <AuthShell
      ...
      pageSubtitle="Create an admin account to manage the platform, customers, and drivers."
      secondaryText="Already have an admin account?"
      secondaryLink="/admin/login"
